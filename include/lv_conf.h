...
/*Enable hardware acceleration for drawing on ESP32 series*/
#define LV_USE_GPU_ESP32_DMA  1

/*Enable JPEG decoding with the ESP32's built-in hardware decoder*/
#define LV_USE_ESP_JPEG 0  
...
// Definir os ranges de caracteres necessários
#define LV_FONT_MONTSERRAT_16_RANGE \
    0x20, 0x7F,    /* ASCII básico */ \
    0xA0, 0xFF,    /* Latin-1 Supplement (inclui ç, ã, etc) */ \
